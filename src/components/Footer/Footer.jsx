...
function Footer() {
  ...
  const changeLanguage = country => appContext.setLanguage(country);
        ...
        <div className="d-flex jc-space-between mobile-fd-column">
          <div className="footer-logo-col">
            ...
            <div className="d-flex social-links">
              <a href="https://www.facebook.com/dncbrasil/" target="_blank">
                <img src={FaceIcon} />
              </a>
              <a href="https://www.twitter.com/dncbrasil" target="_blank">
                <img src={TwitterIcon} />
              </a>
              <a
                href="https://www.linkedin.com/company/dnc-brasil/"
                target="_blank"
              >
                <img src={LinkedinIcon} />
              </a>
              <a href="https://www.instagram.com/dncbrasil/" target="_blank">
          ...
          <div className="d-flex mobile-fd-column">
            ...
            <div className="footer-col">
              ...
              <p className="grey-1-color">
                {appContext.language === 'br' ? 'R.' : 'Street'} Justino Cobra, 61 – Vila Ema | São José dos Campos – SP | CEP
                12243-030
              </p>
